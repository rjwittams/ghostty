...
/**
 * Opaque handle to a resolved Kitty graphics virtual placement iterator.
 *
 * @ingroup kitty_graphics
 */
typedef struct GhosttyKittyGraphicsVirtualPlacementIteratorImpl* GhosttyKittyGraphicsVirtualPlacementIterator;
