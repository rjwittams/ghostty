...
pub const terminal_vt_stream_new = terminal.vt_stream_new;
pub const terminal_vt_stream_free = terminal.vt_stream_free;
pub const terminal_vt_stream_write = terminal.vt_stream_write;
