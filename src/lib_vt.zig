...
comptime {
    ...
    if (@import("root") == lib) {
        ...
        @export(&c.terminal_vt_stream_new, .{ .name = "ghostty_terminal_vt_stream_new" });
        @export(&c.terminal_vt_stream_free, .{ .name = "ghostty_terminal_vt_stream_free" });
        @export(&c.terminal_vt_stream_write, .{ .name = "ghostty_terminal_vt_stream_write" });
